...
//Doesn't compile, on C++17, don't care enough to try and fix.
...
public:
    ...
    friend istream& operator>> (istream& the_i_stream, String the_string);
...
istream& operator>> (istream& the_i_stream, String the_string)
{
    the_i_stream >> the_string.GetString();
    return the_i_stream;
}
